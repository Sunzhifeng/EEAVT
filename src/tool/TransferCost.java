...
public class TransferCost {
	 ...
	 * @return 多少B
	 */
	private static double challengeCost(int c, int n, int p) {
	 ...
	 * @return 多少B
	 */
	private static double challengeCost(int c, int p) {
		return (c + 2) * p;
	}
	 ...
	 * @return 多少B
	 */
	private static double proofCost(int c, int n, int p) {
	 ...
	 * @return 多少B
	 */
	private static double proofCost(int p) {
		return (3 * p);
	}
